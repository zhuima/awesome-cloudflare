...
| [elm.chat](https://github.com/shawnbure/elm-chat) | Account-free disposable encrypted rooms built on Cloudflare Workers + Durable Objects. Browsers hold the room key and transient transcript while the relay forwards ciphertext without persisting server-side chat history. Includes single-use invites, encrypted file transfer, and one-click deployment. Early-stage and not independently audited. | <https://elm.chat/?source=awesome-cloudflare> | Maintaining |
