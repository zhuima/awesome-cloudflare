...
| [HTMLRadar](https://github.com/htmlradar/htmlradar) | Open-source read tracking for HTML documents. Upload an HTML file (proposal, report, deck) and share it as a tracked link — see who opened it, how long they read, and which sections held their attention. Email gating, password protection, link expiry and revocation. Built on Cloudflare Workers + R2 + Supabase. AGPL-3.0, self-hostable. | <https://htmlradar.com> | Maintaining |
