...
| [Flatline](https://github.com/nagpalarpit/flatline) | Self-hostable heartbeat/cron monitor built on Cloudflare Workers, D1, and Cron Triggers. Dead man's switch style pings, SSRF-hardened webhook alerts, tier-based check limits, deploy-your-own with two secrets and no server. | <https://nagpalarpit.github.io/auto-company-www/flatline/> | Active |
...
| [SnapOG](https://github.com/nagpalarpit/snapog) | Self-hostable dynamic Open Graph image API built on Cloudflare Workers + R2, using Satori for edge rendering. Template-based, deploy-your-own with two secrets and no server. | <https://nagpalarpit.github.io/auto-company-www/snapog/> | Maintaining |
