...
| Name | Features | Online Address | Status |
| --- | --- | --- | --- |
| [Social Media Downloader](https://github.com/Vette1123/social-media-downloader) | A social media downloader running on Cloudflare Workers. Paste a link from TikTok, X, Instagram, Facebook, YouTube, Pinterest, Reddit, Threads, Snapchat, Twitch or Vimeo and it returns what the public post serves: HD video, MP3 audio extracted from it, or a photo carousel as a ZIP. No sign-up, no ads, installable as a PWA. Next.js 16 static export with a single Worker doing the extraction, MIT licensed. | <https://www.socialdownloader.space> | Maintaining |
