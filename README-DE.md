...
| [Flowmails](https://github.com/wms-why/flowmails-email-worker) | Verwalteter E-Mail-API-Dienst. Empfangs-Worker + Routing-Regeln + D1 + R2 + Email Routing laufen im eigenen Cloudflare-Konto. Der Base-Tarif ist dauerhaft kostenlos (2 benutzerdefinierte Domains), Pro 9,9 $/Monat. Eingehendes Routing, Posteingang und -ausgang, benutzerdefinierte Domain-Bindung, REST- und Webhook-Automatisierung; Email Services wird direkt von Cloudflare ohne Aufschlag abgerechnet – kein SMTP, keine Drittanbieter-Abhängigkeit. KI-Entwürfe & -Antworten folgen in Q3 2026. | <https://flowmails.net> | Wird gewartet |
...
| [One Stroke Fan](https://github.com/lson-lee/one-stroke) | Mehrsprachige Fanseite auf Basis von Astro und Cloudflare Pages. Unterstützt 9 Sprachen, 100+ Seiten, Sitemap / hreflang / JSON-LD / llms.txt und rein statisches, kostengünstiges Hosting. | <https://one-stroke.savetimefor.fun> | Wird gewartet |
...
| [oddin-status](https://github.com/oddinpay/oddin-status) | Formschöne Statusseite & Uptime-Monitor. Sofort einsatzbereit für den Produktivbetrieb. | <https://status.oddinpay.com/> | Aktiv |
...
| [AWS-AccessBridge](https://github.com/Rexezuge-CloudflareWorkers/AWS-AccessBridge) | AWS Multi-Accounts-Verwaltung und Anmeldung | <https://aws-access-bridge.220cbb9e01920558e6d2862ebf66b298.workers.dev/> | Aktiv gepflegt |
...
| [Cloudflare-WeChat-Notifier](https://github.com/krapnikkk/Cloudflare-WeChat-Notifier) | WeChat-Benachrichtigungsbrücke auf Basis von Cloudflare Workers + Hono + D1 + Queues. Unterstützt QR-Login, Webhook-Eingang, asynchrone Zustellung, Wiederholungen, Dashboard und Protokolle. | | Wird gewartet |
| [Voice to Instrument](https://voicetoinstrument.com?utm_source=github&utm_medium=directory&utm_campaign=backlink) | Kostenloses KI-Tool, das Sprachaufnahmen in Instrumentalspuren wie Klavier, Gitarre oder Schlagzeug umwandelt. | <https://voicetoinstrument.com?utm_source=github&utm_medium=directory&utm_campaign=backlink> | Wird gewartet |
| [TrySchedule](https://www.tryschedule.com/?utm_source=github&utm_medium=directory&utm_campaign=backlink) | Kostenloser Online-Zeitplanersteller, der ohne Anmeldung schnelle Planung und Freigabe von Zeitplänen ermöglicht. | <https://www.tryschedule.com/?utm_source=github&utm_medium=directory&utm_campaign=backlink> | Wird gewartet |
| [Period Calculator](https://www.aiperiodcalculator.com/) | KI-gestützter Zyklus- und Periodenrechner für Tracking, Vorhersagen und verwandte Informationen. | <https://www.aiperiodcalculator.com/> | Wird gewartet |
| [2FAuth Worker](https://github.com/nap0o/2fauth-worker) | Sicherheitsorientiertes 2FA/TOTP-Verwaltungssystem mit Unterstützung für Cloudflare Workers und Docker, inklusive PWA, Offline-Codes und Mehrkanal-Backups. | <https://2fauth.pp.ua> | Wird gewartet |
| [Nano Banana 2](https://nanobananas2.org) | KI-Bildstudio mit Cloudflare R2 und Turnstile für Prompt-basierte Bildgenerierung und Bildbearbeitung, einschließlich Werbung, Poster und E-Commerce-Visuals. | <https://nanobananas2.org> | Wird gewartet |
| [D2Down](https://d2down.com?utm_source=github&utm_medium=directory&utm_campaign=backlink) | Kostenloses Hochgeschwindigkeits-Tool zum Herunterladen und Konvertieren von Online-Videos für YouTube, TikTok und weitere Plattformen. | <https://d2down.com?utm_source=github&utm_medium=directory&utm_campaign=backlink> | Wird gewartet |
| [TOPUPlive](https://www.topuplive.com/?utm_source=github&utm_medium=directory&utm_campaign=backlink) | Online-Aufladeplattform für Mobilfunk, Live-Dienste, Spiele und Geschenkkarten mit mehr als 3.000 Produktkategorien. | <https://www.topuplive.com/?utm_source=github&utm_medium=directory&utm_campaign=backlink> | Wird gewartet |
| [AI Maze Generator](https://github.com/s87343472/ai-maze-generator) | Online-Labyrinthgenerator und Spiel auf Cloudflare Workers mit 10 Labyrinthmodi, täglichen Herausforderungen, Ranglisten, benutzerdefinierter Generierung und PDF-Export. | <https://ai-mazegenerator.com> | Wird gewartet |
| [GetWeb](https://github.com/ZhangShengFan/GetWeb) | Online-Tool zum Verpacken von Webseiten als Windows-EXE mit Cloudflare Workers, GitHub Actions und Electron. Unterstützt benutzerdefinierte Icons, Build-Historie und mehrere GitHub-Tokens. | <https://jishuguai.cc.cd/> | Wird gewartet |
