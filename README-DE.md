...
| [Agora Cosmica](https://github.com/chipmates/agoracosmica) | Bildungsplattform zum Selbsthosten auf Cloudflare Pages + 4 Workers (LLM-Proxy, Audio-Proxy, Community, Statistik) + R2. 30 historische Persönlichkeiten aus Philosophie, Wissenschaft, Kunst, Mystik und Aktivismus für Geschichten, Dialoge und Räte mit mehreren Persönlichkeiten. AGPL-3.0, BYOK-LLM, keine Tracking-Cookies, kein Profiling. | <https://agoracosmica.org> | Wird gewartet |
