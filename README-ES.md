...
| [One Stroke Fan](https://github.com/lson-lee/one-stroke) | Sitio de fans multilingüe construido con Astro y desplegado en Cloudflare Pages. Soporta 9 idiomas, más de 100 páginas, sitemap / hreflang / JSON-LD / llms.txt y hosting estático de bajo costo. | <https://one-stroke.savetimefor.fun> | En mantenimiento |
...
| [Waline On Worker](https://github.com/wuyilingwei/Waline_On_Worker) | Backend en Cloudflare Workers para el sistema de comentarios Waline, con los datos en D1 y sin servidor propio. Compatible con el frontend @waline/client y el panel @waline/admin, con inicio de sesión social, 2FA, filtrado de spam mediante Akismet y LLM, RSS e importación/exportación de datos. |  | En mantenimiento |
...
| [AWS-AccessBridge](https://github.com/Rexezuge-CloudflareWorkers/AWS-AccessBridge) | Gestión y acceso de múltiples cuentas de AWS | <https://aws-access-bridge.220cbb9e01920558e6d2862ebf66b298.workers.dev/> | Mantenido activamente |
...
| [Cloudflare-WeChat-Notifier](https://github.com/krapnikkk/Cloudflare-WeChat-Notifier) | Puente de notificaciones para WeChat construido con Cloudflare Workers + Hono + D1 + Queues. Soporta inicio de sesión por QR, entrada por webhook, entrega asíncrona, reintentos, panel y registros. | | En mantenimiento |
| [Voice to Instrument](https://voicetoinstrument.com?utm_source=github&utm_medium=directory&utm_campaign=backlink) | Herramienta de IA gratuita que convierte grabaciones de voz en pistas instrumentales como piano, guitarra o batería. | <https://voicetoinstrument.com?utm_source=github&utm_medium=directory&utm_campaign=backlink> | En mantenimiento |
| [TrySchedule](https://www.tryschedule.com/?utm_source=github&utm_medium=directory&utm_campaign=backlink) | Constructor de horarios en línea gratuito, sin necesidad de iniciar sesión, para planificar y compartir calendarios rápidamente. | <https://www.tryschedule.com/?utm_source=github&utm_medium=directory&utm_campaign=backlink> | En mantenimiento |
| [Period Calculator](https://www.aiperiodcalculator.com/) | Calculadora de periodo y ciclo impulsada por IA para seguimiento, predicción y consulta de información relacionada. | <https://www.aiperiodcalculator.com/> | En mantenimiento |
| [2FAuth Worker](https://github.com/nap0o/2fauth-worker) | Gestor de 2FA/TOTP centrado en seguridad con soporte para Cloudflare Workers y Docker, incluyendo PWA, códigos offline y respaldos multicanal. | <https://2fauth.pp.ua> | En mantenimiento |
| [Nano Banana 2](https://nanobananas2.org) | Estudio de imágenes con IA que usa Cloudflare R2 y Turnstile para generación y edición de imágenes mediante prompts, incluyendo anuncios, pósteres y visuales para ecommerce. | <https://nanobananas2.org> | En mantenimiento |
| [D2Down](https://d2down.com?utm_source=github&utm_medium=directory&utm_campaign=backlink) | Descargador y convertidor gratuito de videos en línea de alta velocidad para YouTube, TikTok y más plataformas. | <https://d2down.com?utm_source=github&utm_medium=directory&utm_campaign=backlink> | En mantenimiento |
| [TOPUPlive](https://www.topuplive.com/?utm_source=github&utm_medium=directory&utm_campaign=backlink) | Plataforma de recargas en línea para móvil, servicios en vivo, juegos y tarjetas regalo con más de 3.000 categorías de productos. | <https://www.topuplive.com/?utm_source=github&utm_medium=directory&utm_campaign=backlink> | En mantenimiento |
| [AI Maze Generator](https://github.com/s87343472/ai-maze-generator) | Generador de laberintos y juego en línea desplegado en Cloudflare Workers con 10 modos, desafíos diarios, clasificaciones, generación personalizada y exportación PDF. | <https://ai-mazegenerator.com> | En mantenimiento |
| [GetWeb](https://github.com/ZhangShengFan/GetWeb) | Herramienta en línea que empaqueta sitios web como aplicaciones EXE para Windows usando Cloudflare Workers, GitHub Actions y Electron. Soporta iconos personalizados, historial de compilaciones y múltiples tokens de GitHub. | <https://jishuguai.cc.cd/> | En mantenimiento |
...
| [EdgeSonic](https://github.com/wuyilingwei/edgesonic) | Servidor de streaming de música compatible con Subsonic que se ejecuta íntegramente en Cloudflare Workers, sin host permanente. Los metadatos se guardan en D1 y el audio en R2, con WebDAV / S3 también admitidos como backends de almacenamiento; funciona con clientes nativos como DSub y Symfonium e incluye una interfaz web para editar etiquetas y organizar la biblioteca. | <https://edgesonic-demo.wuyilingwei.workers.dev> | En mantenimiento |
