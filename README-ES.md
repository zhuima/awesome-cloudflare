...
| [Flowmails](https://github.com/wms-why/flowmails-email-worker) | Servicio de API de correo electrónico gestionado. El worker receptor + reglas de enrutamiento + D1 + R2 + Email Routing corren dentro de tu propia cuenta de Cloudflare. El plan Base es gratis para siempre (2 dominios personalizados), Pro $9.9/mes. Enrutamiento entrante, bandeja de entrada y salida, vinculación de dominio personalizado, automatización REST + Webhook; Email Services se factura directamente por Cloudflare sin recargo, sin SMTP ni dependencia de terceros. Borradores y respuestas con IA próximamente (Q3 2026). | <https://flowmails.net> | En mantenimiento |
